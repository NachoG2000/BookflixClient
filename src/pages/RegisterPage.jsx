        ...
        <div>
            ...
            <div className="max-w-sm mx-auto my-10 p-6 rounded-lg shadow-lg bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <Button className="w-full" type="submit" disabled={!email || password !== confirmPassword || !password}>Create account</Button>
                    </div>
                </form>
                <div className="text-center">
                    <p className="text-sm text-gray-600">
                        Already have an account?
                        <Link to="/login" className="text-blue-600 no-underline cursor-pointer" href="#">
                            {"\n          "}Login
                        </Link>
                    </p>
                </div>
